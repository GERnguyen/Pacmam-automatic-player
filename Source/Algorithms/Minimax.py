...
def minimaxAgent(_map, pac_row, pac_col, N, M, depth, Score):
    ...
    def min_value(_map, _pac_row, _pac_col, _N, _M, _depth, score, path):
        ...
        for [_d_r, _d_c] in DDX:
            ...
            if isValid(_map, _new_r, _new_c, _N, _M):
                ...
                if state == FOOD:
                    ...
                    score -= 1
                val, p = min_value(_map, _new_r, _new_c, _N, _M, _depth - 1, score, path + [[_new_r, _new_c]])
                if val > v:
                    v = val
                    best_path = p
                _map[_new_r][_new_c] = state
    ...
    for [d_r, d_c] in DDX:
        ...
        if isValid(_map, new_r, new_c, N, M):
            ...
            if _state == FOOD:
                ...
                Score -= 1
            val, path = min_value(_map, new_r, new_c, N, M, depth, Score, [[pac_row, pac_col], [new_r, new_c]])
